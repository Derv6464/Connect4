	...
	ConcreteUser({core.Map<core.String,core.dynamic> cache, jsog}) {
		...
		// from jsog
			...
			if (jsog.containsKey("dywaSwitchedTo")) {
				...
				if(jsogObj != null) {
					ConcreteUser valueaCFl58GsvEe24R4KEeKcnxg;
					...
					if (cache.containsKey(jsogId)) {
						valueaCFl58GsvEe24R4KEeKcnxg = cache[jsogId];
					}
					else {
						if (jsogObj != null) {
							if (jsogObj['dywaRuntimeType'] == "de.ls5.dywa.generated.rest.types.ConcreteUserImpl") {
								valueaCFl58GsvEe24R4KEeKcnxg = new ConcreteUser(cache: cache, jsog: jsogObj);
							}
							else {
								valueaCFl58GsvEe24R4KEeKcnxg = new ConcreteUser(cache: cache,jsog: jsogObj);
							}
					...
					this._dywaSwitchedTo = valueaCFl58GsvEe24R4KEeKcnxg;
				}
			}
